...
if (existingRepository != null) {
    ...
    newConfig.attributes['apt']['distribution'] = parsed_args.distribution
    newConfig.attributes['aptSigning']['keypair'] = parsed_args.keypair
    newConfig.attributes['aptSigning']['passphrase'] = parsed_args.passphrase
